<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AttachmentControl.ascx.cs" Inherits="DotNetNuke.Modules.uDebate_Discussion.Controls.AttachmentControl" %>
